...
interface JFactory
{
    ...
    //receptas iš masyvo $recipes pvz 'sun365'. Ši funkcija turi grąžinti unikalų ID, pagul kurį būtų galima identifikuoti veikiančią produkcijos liniją
    public function stopLine($id); // argumentas veikiančios linijos ID grąžintas iš funkcijos runLine()
    public function info();// išvesti suformatuotą informacią apie padėtį gamykloje: talpyklas, pagamintas pakuotes ir jų skaičių, veikiančias
    //linija
